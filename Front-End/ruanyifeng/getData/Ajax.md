...
- [简介](http://javascript.ruanyifeng.com/bom/ajax.html#toc0)
- [XMLHttpRequest 的实例属性](http://javascript.ruanyifeng.com/bom/ajax.html#toc1)
- [XMLHttpRequest.readyState](http://javascript.ruanyifeng.com/bom/ajax.html#toc2)
- [XMLHttpRequest.onreadystatechange](http://javascript.ruanyifeng.com/bom/ajax.html#toc3)
- [XMLHttpRequest.response](http://javascript.ruanyifeng.com/bom/ajax.html#toc4)
- [XMLHttpRequest.responseType](http://javascript.ruanyifeng.com/bom/ajax.html#toc5)
- [XMLHttpRequest.responseText](http://javascript.ruanyifeng.com/bom/ajax.html#toc6)
- [XMLHttpRequest.responseXML](http://javascript.ruanyifeng.com/bom/ajax.html#toc7)
- [XMLHttpRequest.responseURL](http://javascript.ruanyifeng.com/bom/ajax.html#toc8)
- [XMLHttpRequest.status，XMLHttpRequest.statusText](http://javascript.ruanyifeng.com/bom/ajax.html#toc9)
- [XMLHttpRequest.timeout，XMLHttpRequestEventTarget.ontimeout](http://javascript.ruanyifeng.com/bom/ajax.html#toc10)
- [事件监听属性](http://javascript.ruanyifeng.com/bom/ajax.html#toc11)
- [XMLHttpRequest.withCredentials](http://javascript.ruanyifeng.com/bom/ajax.html#toc12)
- [XMLHttpRequest.upload](http://javascript.ruanyifeng.com/bom/ajax.html#toc13)
- [XMLHttpRequest 的实例方法](http://javascript.ruanyifeng.com/bom/ajax.html#toc14)
- [XMLHttpRequest.open()](http://javascript.ruanyifeng.com/bom/ajax.html#toc15)
- [XMLHttpRequest.send()](http://javascript.ruanyifeng.com/bom/ajax.html#toc16)
- [XMLHttpRequest.setRequestHeader()](http://javascript.ruanyifeng.com/bom/ajax.html#toc17)
- [XMLHttpRequest.overrideMimeType()](http://javascript.ruanyifeng.com/bom/ajax.html#toc18)
- [XMLHttpRequest.getResponseHeader()](http://javascript.ruanyifeng.com/bom/ajax.html#toc19)
- [XMLHttpRequest.getAllResponseHeaders()](http://javascript.ruanyifeng.com/bom/ajax.html#toc20)
- [XMLHttpRequest.abort()](http://javascript.ruanyifeng.com/bom/ajax.html#toc21)
- [XMLHttpRequest 实例的事件](http://javascript.ruanyifeng.com/bom/ajax.html#toc22)
- [readyStateChange 事件](http://javascript.ruanyifeng.com/bom/ajax.html#toc23)
- [progress 事件](http://javascript.ruanyifeng.com/bom/ajax.html#toc24)
- [load 事件、error 事件、abort 事件](http://javascript.ruanyifeng.com/bom/ajax.html#toc25)
- [loadend 事件](http://javascript.ruanyifeng.com/bom/ajax.html#toc26)
- [timeout 事件](http://javascript.ruanyifeng.com/bom/ajax.html#toc27)
- [文件上传](http://javascript.ruanyifeng.com/bom/ajax.html#toc28)
- [参考链接](http://javascript.ruanyifeng.com/bom/ajax.html#toc29)

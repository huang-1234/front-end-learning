...
- [代码嵌入网页的方法](https://javascript.ruanyifeng.com/bom/engine.html#toc0)
- [script 元素嵌入代码](https://javascript.ruanyifeng.com/bom/engine.html#toc1)
- [script 元素加载外部脚本](https://javascript.ruanyifeng.com/bom/engine.html#toc2)
- [事件属性](https://javascript.ruanyifeng.com/bom/engine.html#toc3)
- [URL 协议](https://javascript.ruanyifeng.com/bom/engine.html#toc4)
- [script 元素](https://javascript.ruanyifeng.com/bom/engine.html#toc5)
- [工作原理](https://javascript.ruanyifeng.com/bom/engine.html#toc6)
- [defer 属性](https://javascript.ruanyifeng.com/bom/engine.html#toc7)
- [async 属性](https://javascript.ruanyifeng.com/bom/engine.html#toc8)
- [脚本的动态加载](https://javascript.ruanyifeng.com/bom/engine.html#toc9)
- [加载使用的协议](https://javascript.ruanyifeng.com/bom/engine.html#toc10)
- [浏览器的组成](https://javascript.ruanyifeng.com/bom/engine.html#toc11)
- [渲染引擎](https://javascript.ruanyifeng.com/bom/engine.html#toc12)
- [重流和重绘](https://javascript.ruanyifeng.com/bom/engine.html#toc13)
- [JavaScript 引擎](https://javascript.ruanyifeng.com/bom/engine.html#toc14)
- [参考链接](https://javascript.ruanyifeng.com/bom/engine.html#toc15)
...
- Jake Archibald，[Deep dive into the murky waters of script loading](https://www.html5rocks.com/en/tutorials/speed/script-loading/)
...
- Domenico De Felice, [How browsers work](https://domenicodefelice.blogspot.sg/2015/08/how-browsers-work.html?t=2)
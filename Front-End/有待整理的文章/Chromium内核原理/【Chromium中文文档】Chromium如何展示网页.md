...
所有的与渲染器进程交流的[IPC](https://link.jianshu.com?t=General_Architecture)是在浏览器的I/O线程完成的。这个线程也处理所有的[网络交流](https://link.jianshu.com?t=Multi-process_Resource_Loading.md),使得它不受用户界面的干扰。

...
![Drawing 0.png](14-render-beginWork-1.assets/CgqCHl-8xCmAcvVyAADtTCzN0RM929.png)
...
![Drawing 2.png](14-render-beginWork-1.assets/Ciqc1F-8xByAOzCeAAAoruuugdE734.png)
...
![Drawing 3.png](14-render-beginWork-1.assets/Ciqc1F-8xDeAR3RMAAClHPw_BEk265.png)
...
![1.png](14-render-beginWork-1.assets/CgqCHl-91EqAJlftAAB6KmeoTMw529.png)
...
![2.png](14-render-beginWork-1.assets/CgqCHl-91HeADxF2AACYnkvx4lM165.png)
...
beginWork 开启 Fiber 节点创建过程有一说一，beginWork 的源码实在是长到不科学。这里我们本着抓主要矛盾的原则，针对与树构建过程强相关的动作进行逻辑提取，代码如下（解析在注释里）：
...
![Drawing 6.png](14-render-beginWork-1.assets/CgqCHl-8xHmAV2FMAABmLqBlHD0379.png)
...
![Drawing 7.png](14-render-beginWork-1.assets/CgqCHl-8xIyAZ3VoAADupBJcrgo966.png)
...
![Drawing 8.png](14-render-beginWork-1.assets/Ciqc1F-80U-AfncYAAEt69YE2-g951.png)
...
![Drawing 9.png](14-render-beginWork-1.assets/Ciqc1F-80VaABnJCAACe4hcSiBM598.png)

reconcileSingleElement 将基于 rootFiber 子节点的 ReactElement 对象信息，创建其对应的 FiberNode。这个过程中涉及的函数调用如下图高亮处所示：

![Drawing 10.png](14-render-beginWork-1.assets/CgqCHl-80VyAC2P6AAJfHF2gzfs579.png)
...
![Drawing 11.png](14-render-beginWork-1.assets/CgqCHl-80WaAXLPeAAD-OcP7y4o323.png)
...
![Drawing 12.png](14-render-beginWork-1.assets/CgqCHl-80WyARnfDAAGNRsiaht8973.png)

reconcileChildren 函数上下文里的 workInProgress 就是 rootFiber 节点。那么此时，我们就将新创建的 App Fiber 节点和 rootFiber 关联了起来，整个 Fiber 树如下图所示：

![3.png](14-render-beginWork-1.assets/Ciqc1F-91MmARvQRAADFJC1K20o629.png)
...
![7.png](14-render-beginWork-1.assets/Ciqc1F-97fSAYLUIAAGBjhvNylg581.png)
...
![Drawing 15.png](14-render-beginWork-1.assets/CgqCHl-80ZuAA1HAAAEBle-yZFM332.png)
...
![Drawing 16.png](14-render-beginWork-1.assets/CgqCHl-80aSAF7MKAAEHjyZ0Xwk039.png)

class 为 container 的 DOM 元素对应的节点，其内容如下图所示

![Drawing 17.png](14-render-beginWork-1.assets/Ciqc1F-80aqAJId4AACkvKHjlTM377.png)

h1 标签对应的节点

第 1 个 p 标签对应的 FiberNode，内容为“我是第一段话”，如下图所示

![Drawing 18.png](14-render-beginWork-1.assets/Ciqc1F-80bGAGFKTAADArDpX9j4096.png)

第 2 个 p 标签对应的 FiberNode，内容为“我是第二段话”，如下图所示

![Drawing 19.png](14-render-beginWork-1.assets/CgqCHl-80biASe4KAAEZMaZTIY8632.png)
...
![4.png](14-render-beginWork-1.assets/CgqCHl-91PKANLSRAACt8c-uYAk378.png)
...
![Drawing 21.png](14-render-beginWork-1.assets/CgqCHl-80d2AV6r7AABCQ4zzis4597.png)

return 属性局部截图：

![Drawing 22.png](14-render-beginWork-1.assets/Ciqc1F-80eOAMhlKAACxayioeh4810.png)

sibling 属性局部截图：

![Drawing 23.png](14-render-beginWork-1.assets/CgqCHl-80eiAJ6doAAClFZDD7jE642.png)
...
![5.png](14-render-beginWork-1.assets/Ciqc1F-91RGAAygAAAEYVWI-PXg439.png)
